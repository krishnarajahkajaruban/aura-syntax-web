...
const SEO = ({
  ...
  description = 'Expert software development company specializing in web, mobile, AI, blockchain, and cloud solutions. We build scalable systems that power what\'s next.',
